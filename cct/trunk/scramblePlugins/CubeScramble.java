...
public class CubeScramble extends Scramble {
	...
	private static final String dg = DEFAULT_SOLVE_FACE + " " + DEFAULT_SOLVE_SIDE; //solve the U face on D
	private static final String[] DEFAULT_GENERATORS = { dg, dg, dg, dg, dg, dg, dg, dg, dg, dg };
	private static final int[] DEFAULT_LENGTHS = { 25,	 25,		40,		60,		80,			100,	120,	140,	160,		180 };
	private static final String[] ATTRIBUTES = {"%%multislice%%", "%%widenotation%%", "%%optimalcross%%"};
	...
	private char solveCrossFace = DEFAULT_SOLVE_FACE, solveCrossSide = DEFAULT_SOLVE_SIDE;
